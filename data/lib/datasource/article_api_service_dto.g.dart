...
part of 'article_api_service_dto.dart';
...
class _ArticleApiServiceDto implements ArticleApiServiceDto {
  _ArticleApiServiceDto(this._dio, {this.baseUrl, this.errorLogger}) {
