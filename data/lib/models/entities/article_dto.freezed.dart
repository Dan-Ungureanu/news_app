...
class _$ArticleDtoImpl implements _ArticleDto {
  ...
  @override
  String toString() {
    return 'ArticleDto(id: $id, name: $name, title: $title, author: $author, description: $description, url: $url, urlToImage: $urlToImage, publishedAt: $publishedAt, content: $content)';
  }
